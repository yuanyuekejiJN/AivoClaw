  ...
  return html`
    <div class="settings-skills-section">
      <h2 class="settings-skills-section-title settings-skills-section-toggle"
        ...
        ${(() => {
          const storeInstalledCount = storeSkills.filter((s) => installedSlugs.has(s.slug)).length;
          return storeInstalledCount > 0
            ? html`<span class="settings-skills-count">${storeInstalledCount} 已安装</span>`
            : nothing;
        })()}
      </h2>

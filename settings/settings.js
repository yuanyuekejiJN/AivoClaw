...
(function () {
  ...
  const I18N = {
    en: {
      ...
      "wecom.desc": "Connect WeCom so users can talk to AivoClaw directly in WeCom.",
      ...
      "wecom.dmHint": "Pairing is recommended for direct messages. When set to open, AivoClaw will automatically write allowFrom=[\"*\"].",
      "wecom.docs": "Plugin README →",
      "wecom.getKey": "Open WeCom Admin →",
      "wecom.save": "Save",
      "wecom.saving": "Saving…",
      "dingtalk.desc": "Connect DingTalk so users can talk to AivoClaw directly in DingTalk.",
      ...
      "dingtalk.gatewayHint": "AivoClaw will auto-use the current gateway token and enable the required chatCompletions HTTP endpoint.",
      "dingtalk.docs": "Setup Guide →",
      "dingtalk.getKey": "Open DingTalk Open Platform →",
      "dingtalk.save": "Save",
      "dingtalk.saving": "Saving…",
      "qq.desc": "Connect QQ Bot so users can talk to AivoClaw directly in QQ.",
      "qq.enabled": "Enable",
      ...
      "error.wecomNotBundled": "WeCom plugin is missing. Please reinstall AivoClaw.",
      ...
      "error.dingtalkNotBundled": "DingTalk connector is missing. Please reinstall AivoClaw.",
      "error.noQqAppId": "Please enter the QQ Bot App ID.",
      "error.noQqClientSecret": "Please enter the QQ Bot Client Secret.",
      "error.qqNotBundled": "QQ Bot component is missing. Please reinstall AivoClaw.",
      ...
      "kimi.title": "KimiClaw",
      "kimi.desc": "Control AivoClaw remotely via Kimi",
      "kimi.enabled": "Enable",
      ...
      "advanced.cliUninstallConfirm": "Uninstall the AivoClaw terminal command now?",
      ...
      "about.aivoClawVersion": "AivoClaw Version",
    ...
    zh: {
      ...
      "nav.feishu": "飞书集成",
      "chat.title": "聊天集成",
      "chat.desc": "连接飞书、企业微信、钉钉、Kimi 或 QQ，让用户直接在聊天软件里和 AivoClaw 对话。",
      ...
      "feishu.kindUser": "用户",
      "feishu.kindGroup": "群聊",
      "wecom.desc": "连接企业微信机器人，让用户直接在企业微信里和 AivoClaw 对话。",
      "wecom.enabled": "启用状态",
      "wecom.botId": "Bot ID",
      "wecom.secret": "Secret",
      ...
      "wecom.dmHint": "私聊建议优先使用“先配对再访问”；切到“所有人可直接访问”时，AivoClaw 会自动写入 allowFrom=[\"*\"]。",
      "wecom.docs": "插件说明 →",
      "wecom.getKey": "打开企业微信后台 →",
      "wecom.save": "保存",
      "wecom.saving": "保存中…",
      "dingtalk.desc": "连接钉钉，让用户直接在钉钉里和 AivoClaw 对话。",
      "dingtalk.enabled": "启用状态",
      "dingtalk.clientId": "Client ID / AppKey",
      "dingtalk.clientSecret": "Client Secret / AppSecret",
      "dingtalk.sessionTimeout": "会话超时（毫秒）",
      "dingtalk.sessionTimeoutHint": "默认 1800000 毫秒（30 分钟）。",
      "dingtalk.gatewayHint": "AivoClaw 会自动复用当前 Gateway token，并补齐所需的 chatCompletions HTTP 端点。",
      "dingtalk.docs": "配置指南 →",
      "dingtalk.getKey": "打开钉钉开放平台 →",
      "dingtalk.save": "保存",
      "dingtalk.saving": "保存中…",
      "qq.desc": "连接 QQ Bot，让用户直接在 QQ 中和 AivoClaw 对话。",
      "qq.enabled": "启用状态",
      "qq.appId": "QQ Bot App ID",
      "qq.clientSecret": "Client Secret",
      ...
      "error.wecomNotBundled": "企业微信插件组件缺失，请重新安装 AivoClaw。",
      ...
      "error.dingtalkNotBundled": "钉钉连接器组件缺失，请重新安装 AivoClaw。",
      "error.noQqAppId": "请输入 QQ Bot App ID。",
      "error.noQqClientSecret": "请输入 QQ Bot Client Secret。",
      "error.qqNotBundled": "QQ Bot 组件缺失，请重新安装 AivoClaw。",
      ...
      "nav.backup": "备份恢复",
      "kimi.title": "KimiClaw",
      "kimi.desc": "通过 Kimi 远程遥控 AivoClaw",
      "kimi.enabled": "启用状态",
      ...
      "advanced.cliUninstallConfirm": "确认要卸载 AivoClaw 终端命令吗？",
      "advanced.clawHubRegistry": "ClawHub Registry",
      "advanced.clawHubRegistryPlaceholder": "https://clawhub.ai",
      "advanced.save": "保存",
      "advanced.saving": "保存中…",
      ...
      "about.aivoClawVersion": "AivoClaw 版本",

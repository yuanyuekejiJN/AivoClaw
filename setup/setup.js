...
(function () {
  ...
  const I18N = {
    en: {
      title: "AivoClaw CE Setup",
      "welcome.title": "Welcome to AivoClaw CE",
      "welcome.subtitle": "AivoClaw CE is a one-click installer for OpenClaw. Ready to use out of the box.",
      ...
      "config.keyNotice": "AivoClaw CE does not provide API keys. Please click the link to purchase one from the provider's website.",
      ...
      "done.title": "All Set!",
      "done.subtitle": "AivoClaw CE is ready. Here's what you can do:",
      ...
      "done.start": "Start AivoClaw CE",
      "done.starting": "Starting Gateway…",
      "done.startFailed": "Gateway failed to start. Please click Start AivoClaw CE to retry.",
      "conflict.title": "Existing OpenClaw Detected",
      "conflict.subtitle": "An existing OpenClaw installation was found on your system. This may cause port conflicts with AivoClaw CE.",
    ...
    zh: {
      title: "AivoClaw CE 安装引导",
      "welcome.title": "欢迎使用 AivoClaw CE",
      "welcome.subtitle": "AivoClaw CE 是 OpenClaw 的一键安装包，开箱即用。",
      ...
      "config.keyNotice": "AivoClaw CE 不提供 API 密钥，请点击链接前往服务商官网购买 API 密钥后使用。",
      "config.platform": "平台",
      "config.baseUrl": "接口地址",
      ...
      "done.title": "配置完成！",
      "done.subtitle": "AivoClaw CE 已就绪，你可以：",
      ...
      "done.start": "启动 AivoClaw CE",
      "done.starting": "正在启动 Gateway…",
      "done.startFailed": 'Gateway 启动失败，请点击"启动 AivoClaw CE"重试。',
      "conflict.title": "检测到已安装的 OpenClaw",
      "conflict.subtitle": "系统中已存在 OpenClaw 安装，可能与 AivoClaw CE 产生端口冲突。",

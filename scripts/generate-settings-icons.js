...
function buildSpriteMarkup() {
  ...
  return `<svg id="aivoclaw-settings-icon-sprite" aria-hidden="true" width="0" height="0" style="position:absolute; width:0; height:0; overflow:hidden"><defs>${symbols}</defs></svg>`;
}
...
(function injectAivoClawSettingsIconSprite() {
  if (typeof document === "undefined" || !document.body) return;
  if (document.getElementById("aivoclaw-settings-icon-sprite")) return;
